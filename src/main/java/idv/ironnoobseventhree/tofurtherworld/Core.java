...
public class Core implements ModInitializer {
    ...
    //Ore Gen
    public static ConfiguredFeature<?, ?> CopperGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            CopperOre.getDefaultState(), 10)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 1, 63)).spreadHorizontally().repeat(8));
    public static ConfiguredFeature<?, ?> AluminumGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            AluminumOre.getDefaultState(), 7)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 1, 63)).spreadHorizontally().repeat(15));
    public static ConfiguredFeature<?, ?> TinGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            TinOre.getDefaultState(), 7)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 1, 63)).spreadHorizontally().repeat(10));
    public static ConfiguredFeature<?, ?> LeadGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            LeadOre.getDefaultState(), 5)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 1, 40)).spreadHorizontally().repeat(5));
    public static ConfiguredFeature<?, ?> SilverGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            SilverOre.getDefaultState(), 4)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 2, 29)).spreadHorizontally().repeat(6));
    public static ConfiguredFeature<?, ?> ForgottenIronGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            ForgottenIronOre.getDefaultState(), 2)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 0, 60)).spreadHorizontally().repeat(1));
    /*public static ConfiguredFeature<?, ?> RubyGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            RubyOre.getDefaultState(), 5)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 4, 30)).spreadHorizontally().repeat(3));
    public static ConfiguredFeature<?, ?> SapphireGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            SapphireOre.getDefaultState(), 5)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 4, 30)).spreadHorizontally().repeat(3));
    public static ConfiguredFeature<?, ?> TopazGen = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD,
            TopazOre.getDefaultState(), 5)) .decorate(Decorator.RANGE.configure(
            new RangeDecoratorConfig(0, 4, 30)).spreadHorizontally().repeat(3));*/
    ...
    public void onInitialize() {
        ...
        //Ore gen
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_copper_overworld"), CopperGen);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_aluminum_overworld"), AluminumGen);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_tin_overworld"), TinGen);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_lead_overworld"), LeadGen);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_silver_overworld"), SilverGen);
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier(MODID, "ore_forgotteniron_overworld"), ForgottenIronGen);
